		...
		<li>
			<Link
				...
				class={[
					...
					'relative flex items-center gap-2.5 pl-8 text-base',
					'before:absolute before:right-0 before:h-full before:origin-right before:bg-white before:w-1 before:scale-0 before:transition-transform',
				]}
			>
