...
export const HomeBanner = component$(() => {
  return (
    <section class={[homeBannerStyles.main, "min-h-screen"]}>
      <Wrapper
        class={[
          homeBannerStyles.wrapper,
          "flex flex-col lg:flex-row gap-20 md:gap-36 items-center lg:items-end lg:justify-between text-center lg:text-left mx-auto h-screen md:pb-20 lg:px-20 pt-28 md:pt-52 lg:pt-0",
        ]}
      >
        <div class="max-w-md">
          <p
